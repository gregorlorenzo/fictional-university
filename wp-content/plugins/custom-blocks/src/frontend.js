...
document.addEventListener("DOMContentLoaded", () => {
    const divsToUpdate = document.querySelectorAll(".custom-blocks-update-me")

    divsToUpdate.forEach((div) => {
        const data = JSON.parse(div.querySelector("pre").innerHTML)
        ReactDom.render(<Quiz {...data} />, div)
        div.classList.remove("custom-blocks-update-me")
    })
    ...
    function Quiz(props) {
        ...
        return (
            <div className="custom-blocks-frontend" style={{ backgroundColor: props.bgColor, textAlign: props.titleAlignment }}>
                <p>{props.question}</p>
                <ul>

...
function university_files() {
  wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyAPJnpcbCZ4icxl_PzgOwtK9IvQA6ToiIM', NULL, '1.0', true);
...
// Redirect subscriber account to home page
...
// Remove admin bar for subscibers
...
function myallowedblocks($allowed_block_types, $editor_context) {
  ...
  return array('ourblocktheme/header', 'ourblocktheme/banner', 'ourblocktheme/eventsandblogs', 'ourblocktheme/footer');
}
